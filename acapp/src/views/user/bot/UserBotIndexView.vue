      ...
      <div>
        ...
        >
          ...
          <div>
            ...
            <div>
              <label for="add-bot-content">代码</label>
              <VAceEditor
          ...
          <div style="margin-top: 10px">
            ...
            <button type="button" @click="show_add_modal_handler(false)">
              取消
            </button>
          </div>
        </div>
            ...
            <tr v-for="bot in bots" :key="bot.id">
              ...
              <td>
                <button
                  ...
                  @click="show_update_modal_handler(bot.id, true)"
                >
                  修改
                </button>
                <button
                  ...
                  @click="show_delete_modal_handler(bot.id, true)"
                >
                  删除
                </button>
                ...
                >
                  ...
                  <div>
                    ...
                    <button
                      type="button"
                      @click="show_delete_modal_handler(bot.id, false)"
                    >
                      取消
                    </button>
                  </div>
                ...
                >
                  ...
                  <div style="margin-top: 10px">
                    ...
                    <button type="button" @click="update_bot(bot)">
                      保存修改
                    </button>
                    <button
                      type="button"
                      @click="show_update_modal_handler(bot.id, false)"
                    >
                      取消
                    </button>
                  </div>
...
export default {
  ...
  setup() {
    ...
    const show_delete_modal_handler = (bot_id, is_show) => {
      const new_bots = [];
      for (const bot of bots.value) {
        if (bot.id === bot_id) {
          bot.show_delete_modal = is_show;
        }
        new_bots.push(bot);
      }
      bots.value = new_bots;
